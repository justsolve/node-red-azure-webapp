...
1. Configure the deployment options as an *External repository* pointing to [https://github.com/justsolve/node-red-azure-webapp.git](https://github.com/justsolve/node-red-azure-webapp.git)
